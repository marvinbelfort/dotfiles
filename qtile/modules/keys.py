...
keys = [
    ...
    Key("M-v", lazy.spawn("xfce4-clipman-history"), desc="history"),
    Key("M-<space>",lazy.spawn("rofi -show combi -display-combi '  ' -display-drun '  ' -display-window ' 󰖳 ' "), desc="Move window focus to other window"),
